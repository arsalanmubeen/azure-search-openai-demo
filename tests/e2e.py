...
def test_chat(page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. What other services does QDS provide?)").click()
    page.get_by_placeholder("Type a new question (e.g. What other services does QDS provide?)").fill(
